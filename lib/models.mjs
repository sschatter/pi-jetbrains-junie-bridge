...
export const KNOWN_GRAZIE_MODELS = [
  ...
  // OpenAI — passthrough via ingrazzio-cloud-prod /v1/chat/completions
  "openai-gpt-5-2",
  "openai-gpt-5-4",
  "openai-gpt-5-5",
];
...
const MODEL_METADATA = {
  ...
  "openai-gpt-5-4":             { reasoning: false, contextWindow: 1000000, maxTokens: 32768 },
  "openai-gpt-5-5":             { reasoning: false, contextWindow: 1000000, maxTokens: 32768 },
};

const PREFIX_DEFAULTS = {
  "openai-":   { reasoning: false, contextWindow: 1000000, maxTokens: 32768 },
 ...
 * OpenAI models inherit provider-level api/baseUrl.
